...
SECRET_KEY = os.environ.get(
    'SECRET_KEY',
    '_ck36=1&=u*_620x9al$in(z@ow09deq9la8s7yxta!@hqzx$!'
)
...
WSGI_APPLICATION = 'pubcloud.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'pubcloud'),
        'USER': os.environ.get('DB_USER', 'pubcloud'),
